# -*- encoding: utf-8 -*-
# stub: nanoc-core 4.14.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/nanoc/nanoc/tree/nanoc-core-v4.14.0/nanoc-core" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<immutable-ruby>.freeze, ["~> 0.1"])
  s.add_runtime_dependency(%q<json_schema>.freeze, ["~> 0.19"])
  s.add_runtime_dependency(%q<memo_wise>.freeze, ["~> 1.5"])
