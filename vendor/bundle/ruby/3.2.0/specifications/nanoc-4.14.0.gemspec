...
Gem::Specification.new do |s|
  ...
  s.metadata = { "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/nanoc/nanoc/tree/4.14.0/nanoc" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<nanoc-checking>.freeze, ["~> 1.0", ">= 1.0.2"])
  s.add_runtime_dependency(%q<nanoc-cli>.freeze, ["= 4.14.0"])
